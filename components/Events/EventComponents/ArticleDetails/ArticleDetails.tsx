    ...
    <section className="px-4 py-4">
        ...
        <Row className="align-items-start g-4 flex-column flex-md-row">
          <Col md={8}>
            <div className=" d-flex flex-column gap-3">
              <div className="font-libre fs-26 text-dark fw-semibold">On November 11, 2025,</div>
              <div className="fs-15">Data Centre Leadership Dinner, November 2025</div>
              <div className="fs-15">
                On the evening of 11th November in Mayfair, London, in partnership with Spectrum,
                Vault Partners curated a group of board-level leaders from across the European data
                centre supply chain for a peer group discussion over dinner, and the opportunity to
                network.
              </div>
              <div className="fs-15">The two core topics explored on the night were:</div>
            </div>
          </Col>
      ...
      <div className="article-details-section pb-5 mb-5">
        <Row className="align-items-start g-4 flex-column flex-md-row-reverse">
          <Col md={8}>
            <div className=" d-flex flex-column gap-3">
              <div className="font-libre fs-26 text-dark fw-semibold">Powering the data centre</div>
              <div className="fs-15">
                The energy, commercial and business infrastructure panel provided valuable clarity
                on near- and long-term topics:
              </div>
              <div className="fs-15">
                <ul style={{ paddingLeft: 20 }}>
                  <li>Energy-efficiency will determine the data industry's viability.</li>
                  <li>
                    Artificial intelligence will result in new infrastructure and sector locations.
                  </li>
                  <li>
                    The private sector and public sector must partner for long-term enabling
                    infrastructure and meet the needs of the HPC and digital sector.
                  </li>
                  <li>Renewable energy remains attractive for data centres.</li>
                  <li>Opportunities are abundant for data centre investors.</li>
                  <li>
                    Board discussions also examined the balance of reliability and cost when faced
                    with the sector’s rapidly increasing power and scalability demands.
                  </li>
                </ul>
              </div>
            </div>
