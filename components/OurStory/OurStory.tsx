  ...
  return (
    <div className=" pt-4  pt-lg-5 position-relative d-flex flex-column gap-4 our-story ">
      <div className=" px-4 py-4 d-flex flex-column gap-4">
        ...
        <div className="font-libre fs-42 pb-4 text-dark">Operational Excellence is our Edge</div>
      </div>
      <div>
        <Row className="g-0">
          <Col md={4}>
            <div className="p-3 our-story-card d-flex flex-column justify-content-between gap-4 position-relative">
              ...
              <div className="d-flex flex-column gap-3 mb-4">
                <div className="text-secondary fs-15 border-bottom pb-2">London, UK</div>
                <div className="text-secondary fs-15 border-bottom pb-2">Geneva, CH</div>
                <div className="text-secondary fs-15 border-bottom pb-2">Dubai, UAE</div>
              </div>
            </div>
          </Col>
          <Col md={4}>
            <div className="p-3 our-story-card d-flex flex-column justify-content-between gap-4 position-relative">
              ...
              <div className="d-flex flex-column gap-3 mb-4">
                <div className="text-secondary fs-15 border-bottom pb-2">
                  <span className=" text-white fw-medium">25 years</span> of institutional
                  execution.
                </div>
                <div className="text-secondary fs-15 border-bottom pb-2">
