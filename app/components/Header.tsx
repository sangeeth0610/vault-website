...
const Header = () => {
  ...
  return (
    <header className="vault-header px-4 py-3 d-flex align-items-center justify-content-between">
      <div className="d-flex align-items-center justify-content-between w-100">
        <Image src={logo} alt="Vault Logo" width={100} style={{ marginRight: "32px" }} />
        {isCompact ? (
          <>
            <button
            ...
            >
              <div className="d-flex justify-content-end align-items-center p-4">
                {/* <Image src={logo} alt="Vault Logo" width={100} /> */}
                <button
                  className="btn bg-transparent border-0"
          ...
          <>
                ...
                {menu.map((item, idx) =>
                  !item.submenu ? (
                    <li className="nav-item" key={item.label}>
                      <a className="nav-link text-white" href={item.href}>{item.label}</a>
                    </li>
                  ) : (
                    <li
            ...
            <div>
              <a href="#" className="text-white fw-light fs-14" style={{ textDecoration: "none" }}>
