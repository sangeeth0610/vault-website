...
const BorderButton = ({ text, prefixIconChildren, sufixIconChildren, onClick, style }: BorderButton4Props) => {
  return (
    <button
      className="border-btn border-btn-4 d-flex gap-1 align-items-center"
      onClick={onClick}
      style={style}
    >
